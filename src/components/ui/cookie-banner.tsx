      ...
      <AnimatePresence>
        {showBanner && !showModal && (
          <motion.div
            ...
            className="fixed bottom-4 left-4 right-4 sm:left-6 sm:right-auto sm:max-w-xl z-50 p-6 rounded-3xl glass-card border border-[#C5A059]/40 shadow-2xl bg-[#121824]/95 backdrop-blur-xl text-[#F8F6F0]"
          >
            <div className="flex items-start gap-4 mb-4">
              <div className="w-10 h-10 rounded-xl bg-[#182030] border border-[#C5A059]/40 flex items-center justify-center shrink-0">
                <Cookie className="w-5 h-5 text-[#C5A059]" />
              </div>
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  <h3 className="font-serif text-lg font-bold text-[#F8F6F0]">{t('title')}</h3>
                  <span className="text-[10px] font-semibold text-[#E6C875] bg-[#4A121A] px-2 py-0.5 rounded-full border border-[#E6C875]/30">
                    {t('badge')}
                  </span>
                </div>
            ...
            <div className="flex flex-wrap items-center gap-2 pt-2 border-t border-[#C5A059]/15">
              <button
                ...
                className="px-4 py-2 text-xs font-bold text-[#0B0F17] bg-gradient-to-r from-[#E6C875] to-[#C5A059] hover:from-[#F8F6F0] hover:to-[#E6C875] rounded-full shadow-md transition-all cursor-pointer"
              >
                {t('acceptAll')}
              </button>
              <button
                ...
                className="px-4 py-2 text-xs font-semibold text-[#C2C9D6] bg-[#182030] hover:text-[#F8F6F0] hover:bg-[#202B40] border border-[#C5A059]/30 rounded-full transition-colors cursor-pointer"
              >
                {t('rejectOptional')}
              </button>
              <button
        ...
        {showModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-[#0B0F17]/80 backdrop-blur-xl">
            <motion.div
              ...
              className="glass-card max-w-lg w-full p-6 sm:p-8 rounded-3xl relative border border-[#C5A059]/40 shadow-2xl bg-[#121824] text-[#F8F6F0]"
            >
              <button
                type="button"
              ...
              <div className="flex items-center gap-3 mb-6">
                <div className="w-12 h-12 rounded-2xl bg-[#182030] border border-[#C5A059] flex items-center justify-center">
                ...
                <div>
                  ...
                  <h3 className="font-serif text-xl sm:text-2xl font-bold text-[#F8F6F0]">
                    {t('title')}
                  </h3>
                </div>
              </div>
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="p-4 rounded-2xl bg-[#0B0F17]/80 border border-[#C5A059]/20 flex items-start justify-between gap-4">
                  <div className="space-y-1">
                    <div className="flex items-center gap-2">
                      <Lock className="w-3.5 h-3.5 text-[#C5A059]" />
                      <h4 className="text-sm font-bold text-[#F8F6F0]">{t('necessaryTitle')}</h4>
                    </div>
                    <p className="text-xs text-[#8E9AAF]">{t('necessaryDesc')}</p>
                  </div>
                  <span className="text-xs font-bold text-[#E6C875] bg-[#182030] px-2.5 py-1 rounded-full border border-[#C5A059]/30 shrink-0">
                    Always Active
                  </span>
                </div>
                ...
                <div className="p-4 rounded-2xl bg-[#0B0F17]/80 border border-[#C5A059]/20 flex items-start justify-between gap-4">
                  <div className="space-y-1">
                    <h4 className="text-sm font-bold text-[#F8F6F0]">{t('analyticsTitle')}</h4>
                    <p className="text-xs text-[#8E9AAF]">{t('analyticsDesc')}</p>
                  </div>
                  <button
                    type="button"
